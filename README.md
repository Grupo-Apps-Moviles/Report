...
**Tabla Heurística General**

| Heurística | Resultado |
|---|---|
| Visibilidad del estado del sistema | Parcial |
| Consistencia y estándares | Cumple |
| Prevención de errores | Cumple |
| Reconocimiento antes que memoria | Cumple |
| Flexibilidad y eficiencia de uso | Cumple |
| Diseño estético y minimalista | Cumple |
| Ayuda y documentación | Parcial |
| Correspondencia con el mundo real | Cumple |
| Control y libertad del usuario | Cumple |
| Accesibilidad e inclusión | Parcial |
...
| Problema | Severidad |
|---|---|
| Propuesta de valor poco específica en la Landing Page | 2 |
| Falta de ayuda contextual para nuevos usuarios | 2 |
| Dependencia alta de mapas y geolocalización | 3 |
| Ausencia de feedback visual durante búsquedas | 3 |
| Diferenciación insuficiente entre roles | 2 |
| Uso de términos ambiguos o técnicos | 2 |
